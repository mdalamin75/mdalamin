...
export default function DraftService({ initialData }) {
    ...
    const publishedServices = currentServices.filter(ab => ab.status === 'draft'); // For draft service
    const pageNumbers = [];
        ...
        <AdminLayout>
            <div className="draftportfolio p-6">
                <div className="titledashboard flex flex-sb">
                    <h1 className="text-2xl font-bold mb-4">Admin Draft Service</h1>
                </div>
