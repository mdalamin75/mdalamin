...
export default function draftPortfolio({ initialData }) {
    ...
    const publishedPortfolios = currentPortfolios.filter(ab => ab.status === 'draft'); // For draft portfolio
    const pageNumbers = [];
        ...
        <AdminLayout>
            <div className="draftportfolio p-6">
                <div className="titledashboard flex flex-sb">
                    <h1 className="text-2xl font-bold mb-4">Admin Draft Portfolio</h1>
                </div>
