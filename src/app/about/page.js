      ...
      <section id="about" className="py-10 snap-start">
        <div className="container">
          <div className="about_head">
            <h1
              className={`${josefin.className} uppercase text-center text-5xl font-extrabold py-10 text-transparent bg-clip-text bg-gradient-to-r from-gray-200 to-blue-600`}>
              About Me
            </h1>
          </div>
      ...
      <section id="education" className="py-5 snap-start">
        <div className="container">
          <div className="education_head">
            <h1
              className={`${josefin.className} uppercase text-center text-5xl font-extrabold py-16 text-transparent bg-clip-text bg-gradient-to-r from-gray-200 to-green-600 drop-shadow-2xl`}>
              Education
            </h1>
          </div>
          <div className="timeline">
            <div className="timeline_container after:animate-bounce left">
              <div className={`${titillium.className} content shadow-lg shadow-emerald-600`}>
                <h2>2019 - 2023</h2>
      ...
      <section id="skill" className="py-10 snap-start">
        <div className="container mx-auto">
          <div className="skill_head">
            <h1
              className={`${josefin.className} uppercase text-center text-5xl font-extrabold py-16 text-transparent bg-clip-text bg-gradient-to-r from-gray-200 to-blue-600 drop-shadow-2xl`}>
              Skill & Experience
            </h1>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-x-5">
            ...
            <div className="experience mt-10 md:mt-0">
              <h2 className={`${titillium.className} text-xl font-bold mb-3`}>
                Experience in the Freelancer.com
              </h2>
              <h3 className={titillium.className}>
