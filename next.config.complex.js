...
const nextConfig = {
    ...
    experimental: {
        // Remove fast refresh temporarily
    },
    ...
    // Viewport configuration (replaces viewport meta tag in _document.js)
    async headers() {
        return [
            {
                source: '/(.*)',
    ...
    // Bundle optimization - temporarily simplified
    experimental: {
        // Removed complex experimental features temporarily
    },
