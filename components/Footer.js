  ...
  return (
    <>
      <footer className="mt-auto">
        ...
        <div className="main_footer px-4 z-30">
          <div className="container mx-auto">
            <div className="grid">
              ...
              <div className="menu">
                <nav>
                  <ul className="flex flex-wrap gap-x-5 justify-center text-white">
                    <li>
                      <Link href="/">Home</Link>
                    </li>
                    <li>
            ...
            <p
              className={`${titillium.className} text-center mt-auto py-4 text-white`}>
