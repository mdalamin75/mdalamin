						...
						<ul className="menu bg-base-100 shadow text-base-content min-h-full w-50 p-4 gap-10 sidebar_menu">
							...
							<li>
								<Link href="/admin/about">
									...
									{isDrawerOpen && <span className="text-lg font-bold ml-2">About</span>}
								</Link>
							</li>
							<li>
								<Link href="/admin/services">
									<MdOutlineMedicalServices className="text-xl" />
									{isDrawerOpen &&<span className="text-lg font-bold ml-2">Services</span>}
								</Link>
							</li>
							<li>
								<Link href="/admin/portfolio">
									<IoBriefcaseOutline className="text-xl" />
									{isDrawerOpen &&<span className="text-lg font-bold ml-2">Portfolio</span>}
								</Link>
							</li>
							<li>
								<Link href="/admin/testimonial">
									<MdOutlineReviews className="text-xl" />
									{isDrawerOpen &&<span className="text-lg font-bold ml-2">Testimonial</span>}
								</Link>
							</li>
							<li>
								<Link href="/admin/blog">
									<HiOutlineViewGrid className="text-xl" />
									{isDrawerOpen &&<span className="text-lg font-bold ml-2">Blog</span>}
								</Link>
							</li>
							<li>
								<Link href="/admin/shop">
									<AiOutlineShop className="text-xl" />
									{isDrawerOpen &&<span className="text-lg font-bold ml-2">Shop</span>}
								</Link>
							</li>
							<li>
								<Link href="/admin/contact">
									<GrContact className="text-xl" />
									{isDrawerOpen &&<span className="text-lg font-bold ml-2">Contact</span>}
								</Link>
							</li>
						</ul>
					</div>
